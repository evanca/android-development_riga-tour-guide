...
public class MainActivity extends AppCompatActivity {
    ...
    ViewPager.OnPageChangeListener myOnPageChangeListener =
            new ViewPager.OnPageChangeListener() {
                ...
                // Changing header image depending a page opened:
                @Override
                public void onPageSelected(int position) {
                    ...
                    if (position == 3) {
                        Toast.makeText(getApplicationContext(), R.string.about_insiders_toast, Toast.LENGTH_LONG).show();
                        ImageView imageView = findViewById(R.id.header_image);
    ...
    private void showSnackbar(final String text) {
        View container = findViewById(R.id.main_linear);
        if (container != null) {
